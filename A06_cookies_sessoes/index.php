...
<head>
    ...
    <title>Eletiva LP 4 - PHP - Lista de Exercícios 3</title>
</head>
...
<body>
    <div class="jumbotron jumbotron-fluid">
        ...
        <div class="list-group">
            ...
            <a href="setCookie.php" class="list-group-item list-group-item-action">Set Cookies</a>
            <a href="exibirCookie.php" class="list-group-item list-group-item-action">Exibir Cookies</a>
            <a href="login.php" class="list-group-item list-group-item-action">Login</a>
            <a href="mainPage.php" class="list-group-item list-group-item-action">Página Principal</a>
            <?php
                $descricao = array('Corrida de automóveis','Validação de lote de cheques');
                for ($i=1; $i<=2; $i++){
                ?>
