    ...
    <div class="container p-4">
        ...
        <div class=" p-4">
            <form class="form" id="form1" method="post">
                ...
                <div class="form-group row">
                    <div class="col-sm-10">
                        <input type="submit" class="btn btn-primary" name="bt_ex03" value='Avalie se é par ou ímpar'>
                    </div>
                </div>
            </form>
                ...
                if($_POST) {
                    ...
                    if ($num != "") {
                        ...
                        $result = isEven($num);
                        if ($result == 1)
                            echo"O número $num_formated é PAR! <br>";
                        else 
                            echo"O número $num_formated é ÍMPAR! <br>";
                    }
                    echo "</div>";
                }
                ?>
